      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#portfolio">Liste des clients</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Liste des clients</h2>
          </div>
        </div>
        <div>
	        ...
	        <form method="post" action="">
				...
				<div>
					...
					<select id="action" name="action">
						<option label="---" value=""/>
						<option label="Modifier dossier" value="modify"/> 
						<option label="Afficher les comptes" value="account"/> 
						<option label="Effectuer un transfert" value="transfer"/> 
					</select>
				</div>
